...
namespace ApplicationCore.Migrations
{
    ...
    [Migration("20221114141720_merge_account_customer")]
    partial class merge_account_customer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationCore.Models2.Customer", b =>
                {
            ...
            modelBuilder.Entity("ApplicationCore.Models2.Order", b =>
                {
                    b.HasOne("ApplicationCore.Models2.Account", null)
                        .WithMany("Orders")
                        .HasForeignKey("AccountId");

                    b.HasOne("ApplicationCore.Models2.Customer", "Customer")
                        .WithMany("Orders")
